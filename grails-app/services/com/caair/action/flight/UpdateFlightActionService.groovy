 ...
 */
class UpdateFlightActionService extends BaseService implements ActionServiceIntf {
    ...
    /**
     * While updating an Flight object this method is called first.
     * In this method check all preconditions before updating an Flight object (i.e required params existence, uniqueness of Flight object property)
    ...
    public Map executePreCondition(Map params) {
        try {
            ...
            // @todo check server side validation process (ie Flight object existence , name should be unique)
            // @todo check other logic if you might need before update Flight
            return params
        } catch (Exception ex) {
    ...
    public Map execute(Map result) {
        try {
            ...
            // @todo put newly updated Flight object in result for future reference.
            return result
        } catch (Exception ex) {
            log.error(ex.getMessage())
            throw new RuntimeException(ex)
    ...
    public Map executePostCondition(Map result) {
        // @todo if any functionality needed after update Flight object, add your logic here.
        return result
    }
