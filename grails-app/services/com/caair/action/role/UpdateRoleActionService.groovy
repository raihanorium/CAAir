...
class UpdateRoleActionService extends BaseService implements ActionServiceIntf {
    ...
    /**
     * While updating an Role object this method is called first.
     * In this method check all preconditions before updating an Role object (i.e required params existence, uniqueness of Role object property)
    ...
    public Map executePreCondition(Map params) {
        try {
            ...
            // @todo check server side validation process (ie Role object existence , name should be unique)
            // @todo check other logic if you might need before update Role
            return params
        } catch (Exception ex) {
    ...
    public Map execute(Map result) {
        try {
            // @todo build Role object from result.
            // @todo update Role object, such as roleService.update(Role)
            // @todo put newly updated Role object in result for future reference.
            return result
        } catch (Exception ex) {
            log.error(ex.getMessage())
            throw new RuntimeException(ex)
    ...
    /**
     * This method will call after creating an Role object.
     * Put this method in transactional(readOnly) block if only DB read operation is needed or transactional(read/write) if both read/write is needed.
     *
    ...
    public Map executePostCondition(Map result) {
        // @todo if any functionality needed after update Role object, add your logic here.
        return result
    }
