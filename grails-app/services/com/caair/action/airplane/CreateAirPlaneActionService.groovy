 ...
 */
class CreateAirPlaneActionService extends BaseService implements ActionServiceIntf {
    ...
    /**
     * While creating an AirPlane object this method is called first.
     * In this method check all preconditions before creating a new AirPlane object (i.e required params existence, uniqueness of AirPlane object property)
    ...
    public Map executePreCondition(Map params) {
        try {
            ...
            // @todo check server side validation process (ie AirPlane name should be unique)
            // @todo check other logic if you might need before create AirPlane
            return params
        } catch (Exception ex) {
     ...
     * Create a new AirPlane object in DB
    ...
    public Map execute(Map result) {
        try {
            ...
            // @todo create new AirPlane object, such as airPlaneService.create(AirPlane)
            // @todo put newly crated AirPlane object in result for future reference.
            return result
        } catch (Exception ex) {
            log.error(ex.getMessage())
            throw new RuntimeException(ex)
    ...
    public Map executePostCondition(Map result) {
        // @todo if any functionality needed after create AirPlane object, add your logic here.
        return result
    }
