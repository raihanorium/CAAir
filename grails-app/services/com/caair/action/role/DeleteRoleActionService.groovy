...
class DeleteRoleActionService extends BaseService implements ActionServiceIntf {
    ...
    /**
     * While deleting an Role object this method is called first.
     * In this method check all preconditions before deleting an Role object (i.e required params existence, association of Role object)
    ...
    public Map executePreCondition(Map params) {
        try {
            ...
            // @todo read Role object roleService.read(id)
            // @todo check server side validation process (ie Role object existence,association)
    ...
    public Map execute(Map result) {
        try {
            ...
            // @todo delete Role object, such as roleService.delete(Role)
            return result
        } catch (Exception ex) {
            log.error(ex.getMessage())
            throw new RuntimeException(ex)
    ...
    public Map executePostCondition(Map result) {
        // @todo if any functionality needed after delete Role object, add your logic here.
        return result
    }
