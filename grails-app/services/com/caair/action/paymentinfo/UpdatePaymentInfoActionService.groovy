 ...
 */
class UpdatePaymentInfoActionService extends BaseService implements ActionServiceIntf {
    ...
    /**
     * While updating an PaymentInfo object this method is called first.
     * In this method check all preconditions before updating an PaymentInfo object (i.e required params existence, uniqueness of PaymentInfo object property)
    ...
    public Map executePreCondition(Map params) {
        try {
            ...
            // @todo check server side validation process (ie PaymentInfo object existence , name should be unique)
     ...
     * Update an PaymentInfo object in DB
    ...
    public Map execute(Map result) {
        try {
            ...
            // @todo update PaymentInfo object, such as paymentInfoService.update(PaymentInfo)
            // @todo put newly updated PaymentInfo object in result for future reference.
            return result
        } catch (Exception ex) {
            log.error(ex.getMessage())
            throw new RuntimeException(ex)
