...
/**
 *  Create new TicketInfo object
 */
class CreateTicketInfoActionService extends BaseService implements ActionServiceIntf {
    ...
    /**
     * While creating an TicketInfo object this method is called first.
     * In this method check all preconditions before creating a new TicketInfo object (i.e required params existence, uniqueness of TicketInfo object property)
    ...
    public Map executePreCondition(Map params) {
        try {
            ...
            // @todo check server side validation process (ie TicketInfo name should be unique)
            // @todo check other logic if you might need before create TicketInfo
            return params
        } catch (Exception ex) {
     ...
     * Create a new TicketInfo object in DB
    ...
    public Map execute(Map result) {
        try {
            ...
            // @todo create new TicketInfo object, such as ticketInfoService.create(TicketInfo)
            // @todo put newly crated TicketInfo object in result for future reference.
            return result
        } catch (Exception ex) {
            log.error(ex.getMessage())
            throw new RuntimeException(ex)
