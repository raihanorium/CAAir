...
/**
 *  Show list of My Booking TicketInfo
 */
class ShowMyBookingTicketInfoActionService extends BaseService implements ActionServiceIntf {
     ...
     * Pull my booking TicketInfo list from database
     *
    ...
    public Map execute(Map result) {
        try {
            // @todo get list of TicketInfo object (i.e. ticketInfoService.listByCustomerId(id))
            // @todo get count of TicketInfo object (i.e. ticketInfoService.countByCustomerId(id))
