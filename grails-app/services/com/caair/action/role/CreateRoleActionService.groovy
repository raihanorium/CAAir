...
class CreateRoleActionService extends BaseService implements ActionServiceIntf {
    ...
    /**
     * While creating an Role object this method is called first.
     * In this method check all preconditions before creating a new Role object (i.e required params existence, uniqueness of Role object property)
    ...
    public Map executePreCondition(Map params) {
        try {
            ...
            // @todo check server side validation process (ie Role name should be unique)
            // @todo check other logic if you might need before create Role
            return params
        } catch (Exception ex) {
    ...
    public Map execute(Map result) {
        try {
            ...
            // @todo create new Role object, such as roleService.create(Role)
            // @todo put newly crated Role object in result for future reference.
            return result
        } catch (Exception ex) {
            log.error(ex.getMessage())
            throw new RuntimeException(ex)
    ...
    public Map executePostCondition(Map result) {
        // @todo if any functionality needed after create Role object, add your logic here.
        return result
    }
