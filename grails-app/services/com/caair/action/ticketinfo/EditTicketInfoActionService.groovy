...
/**
 *  Get TicketInfo object from DB
 */
class EditTicketInfoActionService extends BaseService implements ActionServiceIntf {
    ...
    /**
     * While getting an TicketInfo object this method is called first.
     * In this method check all preconditions before getting an old TicketInfo object (i.e required params, existence of TicketInfo object)
    ...
    public Map executePreCondition(Map params) {
        try {
            ...
            // @todo check server side validation process (ie TicketInfo object existence)
    ...
    public Map execute(Map result) {
        try {
            ...
            // @todo check other logic if you might need before get TicketInfo
            return result
        } catch (Exception e) {
    ...
    public Map executePostCondition(Map result) {
        // @todo if any functionality needed after get TicketInfo object, add your logic here.
        return result
    }
